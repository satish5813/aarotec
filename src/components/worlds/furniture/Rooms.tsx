  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-x-0 bottom-0 flex items-end justify-between p-7 sm:p-9">
        <div>
          <p className="label text-white/70">{r.label}</p>
          <p className="font-serif mt-1 text-3xl font-medium text-white">{r.piece}</p>
        </div>
        <span className="grid h-11 w-11 place-items-center rounded-full border border-white/40 text-white transition-colors group-hover:bg-white group-hover:text-ink">
